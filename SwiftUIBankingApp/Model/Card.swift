...
var sampleCards: [Card] = [
    ...
    .init(cardName: "CardHolder", cardColor: Color("Card 1"), cardBalance: "$1024.9", expenses: [
    ...
    .init(cardName: "CardHolder", cardColor: Color("Card 2"), cardBalance: "$2439.5", expenses: [
    ...
    .init(cardName: "CardHolder", cardColor: Color("Card 3"), cardBalance: "$459.78", expenses: [
